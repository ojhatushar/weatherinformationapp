...
import com.test.weatherinfo.databinding.CustomDialogPermissionLayoutBinding
import com.test.weatherinfo.databinding.PermissionsItemBinding
...
class CustomDialogFragment() : RationaleDialogFragment() {
    ...
    private var _binding: CustomDialogPermissionLayoutBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = CustomDialogPermissionLayoutBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun buildPermissionsLayout() {
        for (permission in mPermissions) {
            ...
            if (permissionGroup != null && !groupSet.contains(permissionGroup)) {
                val itemBinding =
                    PermissionsItemBinding.inflate(layoutInflater, binding.permissionsLayout, false)
